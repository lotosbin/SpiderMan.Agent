...
window.spGrab = function() {
  var caps, data, fixLostYesrDate, monthDiff, processCap, processTeamName;
  ...
  processTeamName = function(teamName) {
    if (teamName === '巴黎圣日尔曼') {
      teamName = '巴黎圣日耳曼';
    }
    return teamName;
  ...
  monthDiff = function(d1, d2) {
    ...
    return (_ref = months <= 0) != null ? _ref : {
      0: months
    };
  };
  fixLostYesrDate = function(datetime) {
  ...
  $("#pagebody>table td.bh").each(function() {
    var capString, datetime, item, line1, line2, point, pointGuest, quarter, status, team, teamGuest, time;
    capString = $(this).text();
