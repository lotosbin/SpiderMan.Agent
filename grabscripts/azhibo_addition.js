...
window.spGrab = function() {
  ...
  caps = ['NBA', 'CBA', 'F1', '高尔夫', '男篮世锦赛', '天下足球', '男篮亚锦赛', '吉尼斯国际冠军杯', '德甲', '西甲', '意甲', '英超', '法甲', '欧冠', '世界杯', '欧洲杯', '美洲杯', '亚洲杯', '亚冠', '欧联杯', '足总杯', '国王杯', '联赛杯', '意大利杯', '德国杯', '足协杯', '中超', '土伦杯', '篮球友谊赛', '足球友谊赛', '世界杯热身赛', '网球', '乒乓球', '慈善盾杯', '解放者杯'];
  data = [];
